    ...
    >
      <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-lg p-8 border border-gray-200/50">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join MediMind ASK today</p>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <label
                  htmlFor="patient"
                  className="block p-4 text-center border border-gray-300 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-700 hover:bg-gray-50 transition-colors"
                >
                  Patient
                </label>
              </div>
